...
if (isset($_POST['activate']))
{
	...
	//function to count the rows of the result
	$num = mysql_num_rows($rs_check);
	// Match row found with more than 1 results  - the user is authenticated.
	if ( $num <= 0 )
	{
...
<div class="well">
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="activ_form" class="form-horizontal">
	...
	<tr>
	<td colspan="2" align="center"><input type="submit" name="activate" class="btn btn-info	" value="Activate Account" /></td>
	</tr>
	</table>
	</form>
