		...
		if(empty($err))
		{
			...
			echo "<script>$(function(){";
				foreach ($err as &$errorval) {
					echo "$('#error').append('<b>$errorval</b><br/>');";
				}
			echo "});</script>";
		}
	}
		...
		<div id="page-wrap">
			...
			<div id="content-wrap">
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="register_form">
				  <fieldset>
					<label><?php echo stripslashes($username); ?></label>
					<input type="text" name="register_user_name" class="required" placeholder="eg. irock22">
					
					<label><?php echo stripslashes($email); ?></label>
					<input type="text" name="register_email" class="required email" placeholder="eg. irock22@gmail.com">
					
					<label><?php echo stripslashes($password); ?></label>
					<input type="text" name="register_password" class="required" placeholder="eg. password1234">
					
					<label><?php echo stripslashes($repeat_password); ?></label>
